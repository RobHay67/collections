...
def scope_file_locations(scope):
	...
	scope.path_dvds_file   = pathlib.Path.home().joinpath( scope.folder_files, 'dvds.csv' )

	scope.path_to_missing_dvd_cover = pathlib.Path.home().joinpath( scope.folder_dvd_covers, 'x.jpg' )
